      ...
      begin
        ...
        case messageType of
          ...
          begin
            ...
            Memomessage := 'Декодировано:' + ' ' + BoolToStr(isNew) + ' ' + FormatDateTime(
              'hhmm', ztime) + ' ' + IntToStr(SNR) + ' ' +
          ...
          begin
            ...
            Memo1.Lines.Add('QSO сохранено: Дата:' +
              ...
              ' Частота:' + IntToStr(frequency) + ' Мода:' + mode + ' RST отправлено: ' +
              report + ' RST получено:' +
              reportReceived + ' TX мощность:' + TXPower +
              ' Комментарий:' + comments + ' Имя:' + DXName);
             ...
             MainForm.ComboBox1.Text:=FormatFloat('0.000"."00',frequency/1000000);//IntToStr(frequency);
             ...
             MainForm.Edit11.Text:='TX Power: ' + TXPower + ' / '+comments;
             MainForm.SpeedButton8.Click;

          end
          else begin
            Memo1.Lines.Add('Непонятный тип сообщения:' + IntToStr(messageType));
              WSJT_Run:=False;
          end;
        end;
      end;
