...
begin
  ...
  IniF.WriteBool('GridSettings', 'ColVisible7', CheckBox8.Checked);
  IniF.WriteBool('GridSettings', 'ColVisible8', CheckBox9.Checked);
  IniF.WriteBool('GridSettings', 'ColVisible9', CheckBox10.Checked);
  IniF.WriteBool('GridSettings', 'ColVisible10', CheckBox11.Checked);
  IniF.WriteBool('GridSettings', 'ColVisible11', CheckBox12.Checked);
  IniF.WriteBool('GridSettings', 'ColVisible12', CheckBox13.Checked);
  IniF.WriteBool('GridSettings', 'ColVisible13', CheckBox14.Checked);
  IniF.WriteBool('GridSettings', 'ColVisible14', CheckBox15.Checked);
  IniF.WriteBool('GridSettings', 'ColVisible15', CheckBox16.Checked);
  IniF.WriteBool('GridSettings', 'ColVisible16', CheckBox17.Checked);
  IniF.WriteBool('GridSettings', 'ColVisible17', CheckBox18.Checked);
  IniF.WriteBool('GridSettings', 'ColVisible18', CheckBox19.Checked);
  IniF.WriteBool('GridSettings', 'ColVisible19', CheckBox20.Checked);
  IniF.WriteBool('GridSettings', 'ColVisible20', CheckBox21.Checked);
  IniF.WriteBool('GridSettings', 'ColVisible21', CheckBox22.Checked);
  IniF.WriteBool('GridSettings', 'ColVisible22', CheckBox23.Checked);
  IniF.WriteBool('GridSettings', 'ColVisible23', CheckBox24.Checked);
  IniF.WriteBool('GridSettings', 'ColVisible24', CheckBox25.Checked);
  IniF.WriteBool('GridSettings', 'ColVisible25', CheckBox26.Checked);
  IniF.WriteBool('GridSettings', 'ColVisible26', CheckBox27.Checked);
  IniF.WriteBool('GridSettings', 'ColVisible27', CheckBox28.Checked);
  IniF.WriteBool('GridSettings', 'ColVisible28', CheckBox29.Checked);
...
begin
  ...
  CheckBox8.Checked := IniF.ReadBool('GridSettings', 'ColVisible7', True);
  CheckBox9.Checked := IniF.ReadBool('GridSettings', 'ColVisible8', True);
  CheckBox10.Checked := IniF.ReadBool('GridSettings', 'ColVisible9', True);
  CheckBox11.Checked := IniF.ReadBool('GridSettings', 'ColVisible10', True);
  CheckBox12.Checked := IniF.ReadBool('GridSettings', 'ColVisible11', True);
  CheckBox13.Checked := IniF.ReadBool('GridSettings', 'ColVisible12', True);
  CheckBox14.Checked := IniF.ReadBool('GridSettings', 'ColVisible13', True);
  CheckBox15.Checked := IniF.ReadBool('GridSettings', 'ColVisible14', True);
  CheckBox16.Checked := IniF.ReadBool('GridSettings', 'ColVisible15', True);
  CheckBox17.Checked := IniF.ReadBool('GridSettings', 'ColVisible16', True);
  CheckBox18.Checked := IniF.ReadBool('GridSettings', 'ColVisible17', True);
  CheckBox19.Checked := IniF.ReadBool('GridSettings', 'ColVisible18', True);
  CheckBox20.Checked := IniF.ReadBool('GridSettings', 'ColVisible19', True);
  CheckBox21.Checked := IniF.ReadBool('GridSettings', 'ColVisible20', True);
  CheckBox22.Checked := IniF.ReadBool('GridSettings', 'ColVisible21', True);
  CheckBox23.Checked := IniF.ReadBool('GridSettings', 'ColVisible22', True);
  CheckBox24.Checked := IniF.ReadBool('GridSettings', 'ColVisible23', True);
  CheckBox25.Checked := IniF.ReadBool('GridSettings', 'ColVisible24', True);
  CheckBox26.Checked := IniF.ReadBool('GridSettings', 'ColVisible25', True);
  CheckBox27.Checked := IniF.ReadBool('GridSettings', 'ColVisible26', True);
  CheckBox28.Checked := IniF.ReadBool('GridSettings', 'ColVisible27', True);
  CheckBox29.Checked := IniF.ReadBool('GridSettings', 'ColVisible28', True);
